...
#. Get the extension
   ...
   #. **Get it from the Extension Manager:**
      ...
      *ns_youtube* and import the extension from the repository.

   #. **Get it from typo3.org:** You can always get the current version from
      https://extensions.typo3.org/extension/ns_youtube/ by downloading either
      the t3x or zip version. Upload the file afterwards in the Extension Manager.

   .. figure:: Images/TYPO3_NS_YOUTUBE_Install_1.png
...
#. Activate the TypoScript
   ...
   #. Select **[NITSAN] ns_youtube** at the field *Include static
      (from extensions):*

   #. Include **[NITSAN] ns_youtube** at the last place.

   .. figure:: Images/TYPO3_NS_YOUTUBE_Install_2.png
       :alt: installation 2
       :width: 1100px
